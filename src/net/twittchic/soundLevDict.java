...
//						}
        ...
        for(int i = 0; i < cand.size(); i++)
        {
            ...
            if(computeLevenshteinDistance(cand.get(i),str) == 1)
...
//		System.out.println(cand);
    ...
    public static String elSoundConf(String word)
    {
...
//						retWord = candSound.get(0);
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(elSoundConf("deneme: " + "etttttiiiiiiiiiiimmmmmmmmmmmm"));
        elSound("ediyomuşum");
